/* ============================================================
   enhance.js — Luliy Blog v4 增强版
   新增：完整五主题切换CSS系统（自动注入，无需额外文件）
   原功能全部保留：TOC悬浮/折叠、favorites加密、粒子背景等
   ============================================================ */
(function (root) {
  'use strict';
  ...
  function injectThemeCSS() {
    if (document.getElementById('luliy-theme-css')) return;
    const css = document.createElement('style');
    css.id = 'luliy-theme-css';
    css.textContent = `
/* 全局主题变量定义 */
:root {
...
pre .mac-btn-red { left: 12px; background: #ff5f56; }
pre .mac-btn-yellow { left: 32px; background: #ffbd2e; }
pre .mac-btn-green { left: 52px; background: #27c93f; }

pre .mac-btn:hover { opacity: 0.8; }
...
.luliy-toc-wrap.is-open .luliy-toc-arrow {
...
.luliy-toc-wrap .toc ul {
  list-style: none;
  padding-left: 0;
  margin: 0;
}

.luliy-toc-wrap .toc li {
  margin: 6px 0;
  padding-left: 12px;
}

.luliy-toc-wrap .toc li li {
  padding-left: 20px;
  font-size: 13px;
}
...
@media (min-width: 1100px) {
  .has-sidebar-toc .luliy-toc-sidebar {
    display: block;
  }
}
...
#luliy-lightbox-close:hover {
  background: rgba(255,255,255,0.3);
}

/* 主题定义 */
[data-luliy-theme="default"] {
  --primary-color: #f0b429;
  --primary-light: #fef3c7;
  --primary-dark: #d97706;
}

[data-luliy-theme="classic-blue"] {
  --primary-color: #60a5fa;
  --primary-light: #dbeafe;
  --primary-dark: #2563eb;
}

[data-luliy-theme="eco-green"] {
  --primary-color: #34d399;
  --primary-light: #d1fae5;
  --primary-dark: #059669;
}

[data-luliy-theme="sunset"] {
  --primary-color: #fb923c;
  --primary-light: #fed7aa;
  --primary-dark: #ea580c;
}

[data-luliy-theme="mono"] {
  --primary-color: #6b7280;
  --primary-light: #f3f4f6;
  --primary-dark: #374151;
}

[data-luliy-theme="cyberpunk"] {
